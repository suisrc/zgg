...
func TestBasic(t *testing.T) {
	...
	m := sqlx.NewMapperFunc("", func(s string) string { return s })
...
func TestBasicEmbedded(t *testing.T) {
	...
	m := sqlx.NewMapperFunc("db", func(s string) string { return s })
...
func TestInlineStruct(t *testing.T) {
	m := sqlx.NewMapperTagFunc("db", strings.ToLower, nil)
...
func TestRecursiveStruct(t *testing.T) {
	...
	m := sqlx.NewMapperFunc("db", strings.ToLower)
	var p *Person
...
func TestTagNameMapping(t *testing.T) {
	...
	m := sqlx.NewMapperTagFunc("json", strings.ToUpper, func(value string) string {
...
func TestGetByTraversal(t *testing.T) {
	...
	m := sqlx.NewMapperFunc("db", func(n string) string { return n })
...
func TestFieldByIndexes(t *testing.T) {
	...
	for i, tc := range testCases {
		...
		checkResults(sqlx.FieldByIndexes(reflect.ValueOf(tc.value), tc.indexes))
		if tc.readOnly {
			checkResults(sqlx.FieldByIndexesReadOnly(reflect.ValueOf(tc.value), tc.indexes))
		}
	}
}
...
func TestMustBe(t *testing.T) {
	...
	sqlx.MustBe(typ, reflect.Struct)
